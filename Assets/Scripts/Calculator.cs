...
public class Calculator : MonoBehaviour
{
    ...
    public void Add()
    {
        ...
        float result = 0;
        result = prevInput + float.Parse(text.text);
    ...
    public void Calculate()
    {
        ...
        switch (equationType) 
        {
            case EquationType.ADD: Add(); break;
            case EquationType.SUBTRACT: Subtract(); break;
            case EquationType.MULTIPLY: Multiply(); break;
            case EquationType.DIVIDE: Divide(); break;
        }
    }
